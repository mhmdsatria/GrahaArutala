                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('activities.update',$activity->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="text" name="title"
                                    ...
                                    placeholder="" value="{{old('title',$activity->title)}}" />
                            </label>
                            @error('title')
                        ...
                        <div class="mb-6">
                            <label class="block">
                                ...
                                <textarea
                                    ...
                                    name="content" rows="3">{{old('content',$activity->content)}}</textarea>
                            </label>
                            <script>
                        ...
                        <div class="mb-6">
                            ...
                            @enderror
                            <img src="{{ asset($activity->image) }}" class="w-12 h-12" alt="{{ asset($activity->image) }}">
                        </div>
                        <button type="Update"
