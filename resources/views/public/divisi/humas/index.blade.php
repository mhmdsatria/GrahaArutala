...
<div class="grid md:grid-cols-4 gap-y-10 md:px-32 py-20">
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        ...
        <div class="absolute bottom-0 py-5 px-5 filter-none">
            <h3 class="font-bold">Muhamad Halim</h3>
            <h6>Koordinator</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        ...
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Nenden Putri Nurul S</h3>
            <h6>Sekertaris</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Hanifa Mulyasari</h3>
            <h6>Administrasi</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Ram Darmansyah</h3>
            <h6>Ekternal</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Rega Aditya Perdana</h3>
            <h6>Ekternal</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Rendika Febrian</h3>
            <h6>Ekternal</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">M. Hilal Almufti</h3>
            <h6>Internal</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Syarifudin Fajar S</h3>
            <h6>Internal</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">M Dafik Kholik Firdaus</h3>
            <h6>Internal</h6>
        </div>
    </div>
</div>
