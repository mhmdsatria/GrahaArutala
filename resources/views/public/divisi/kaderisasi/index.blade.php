...
<div class="grid md:grid-cols-4 gap-y-10 md:px-32 py-20">
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        ...
        <div class="absolute bottom-0 py-5 px-5 filter-none">
            <h3 class="font-bold">Verico Rivanto Junior</h3>
            <h6>Koordinator</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        ...
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Moch Adrik F</h3>
            <h6>Edukasi Fudamental</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Siti Alfiyyatuz Zakiyyah A</h3>
            <h6>Edukasi Fudamental</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Abdul Shabur Nurhadi Ikram</h3>
            <h6>Edukasi Fudamental</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Moch Taufik Faturrahman</h3>
            <h6>Edukasi Lanjutan</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">Riska Nopiyanti</h3>
            <h6>Edukasi Lanjutan</h6>
        </div>
    </div>
    <div class="relative shadow-2xl w-[250px] rounded-3xl mx-auto md:mx-0 hover:-translate-y-2 duration-300">
        <img src="../assets/sample portrait.png" alt="" />
        <div class="absolute bottom-0 py-5 px-5">
            <h3 class="font-bold">M. Firdaus</h3>
            <h6>Edukasi Lanjutan</h6>
        </div>
    </div>
</div>
